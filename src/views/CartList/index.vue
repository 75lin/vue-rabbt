      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="cartStore.isAll" @change="(selected)=>cartStore.allSelect(selected)"/>
              </th>
          ...
          <tbody>
            <tr v-for="i in cartStore.cartList" :key="i.id">
              <td>
                <el-checkbox :model-value="i.selected" @change="(selected)=>toggleSelecte(i,selected)" />
              </td>
              <td>
                <div class="goods">
